    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='images.image')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddIndex(
            model_name='image',
            index=models.Index(fields=['user', '-created_at'], name='images_imag_user_id_2b12b9_idx'),
        ),
        migrations.AddIndex(
            model_name='imagetask',
            index=models.Index(fields=['image', '-created_at'], name='images_imag_image_i_9ea273_idx'),
        ),
    ]
